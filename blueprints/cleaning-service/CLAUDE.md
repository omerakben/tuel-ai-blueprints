...
6. **Client information stays here and stays minimal.** Preferences and visit rhythms help the business; card numbers, government IDs, and health details never belong in these files. If the owner pastes something that should not be kept, say so and leave it out.
