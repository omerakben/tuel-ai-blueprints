...
Closes out the night with you step by step, then shows you tomorrow at a glance.
...
You can skip the schedule too. Any night, open this folder and say the prompt when the last table leaves. It works the same.
...
It's closing time. Read the business/ folder first — it is the source of truth for the restaurant.
...
3. Preview tomorrow in 3 lines: the first reservation, any big party, plus any prep worth flagging. If you don't have tomorrow's book, say so and ask me for it.
