...
A short rundown of your day before doors open, saved where you can find it again.
...
In Claude Desktop, create a scheduled task and pick a time before you open — while the coffee is on works well. Paste the prompt below as the task's instructions, exactly as written.

You don't need the schedule, though. Any morning, open this folder and say the prompt yourself. Same brief either way.

One thing the brief needs: today's book. Paste it into the chat, or save the day's reservation list into the inbox/ folder the night before. If Claude can't find today's book, it asks you for it instead of guessing.
...
Time for the morning brief. Read the business/ folder first — it is the source of truth for the restaurant.
...
3. Write a brief of 6 to 8 lines covering: what's on the book today and any big parties, where the quiet stretches are, anything to prep (a special to write up, a regular's usual table noted in business/clients.md), follow-ups still waiting on me, and one small suggestion for the day.
