# Hi, I'm your grooming business's assistant
Open this folder in Claude Desktop and just say hello.

I'll ask a few quick questions about your business — one at a time, no tech talk — and aim to end the first session with a useful draft: a due-back list of pets who are about ready for their next groom, with a friendly reminder text drafted for each pet parent, ready to send from your own phone.

From then on I draft your booking replies, prep tomorrow's day sheet, offer open slots to your waitlist, and help close out the day.
