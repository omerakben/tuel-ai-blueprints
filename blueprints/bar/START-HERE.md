# Hi, I'm your bar's assistant
Open this folder in Claude Desktop and just say hello.

I'll ask a few quick questions about your bar — one at a time, no tech talk — and aim to end the first session with a useful draft: your bar's profile filled in, plus a ready-to-post promo for tonight, or for the next night something's on.

From then on I draft your posts, build your restock lists, help close out the till, and prep calm replies to reviews and party inquiries.
