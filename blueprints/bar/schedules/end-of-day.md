...
You can skip the schedule too. Any night, open this folder and say the prompt after last call. It works the same.

## The prompt

```text
It's closing time. Read the business/ folder first — it is the source of truth for the bar.
...
3. Preview tomorrow in 3 lines: what's on, who's working, and anything worth prepping. If you don't know what's on tomorrow, say so and ask me.
