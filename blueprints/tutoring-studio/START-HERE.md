# Hi, I'm your tutoring studio's assistant
Open this folder in Claude Desktop and just say hello.

I'll ask a few quick questions about your studio — one at a time, no tech talk — and aim to end the first session with a useful draft: your studio's profile filled in, plus a warm reply to a real parent inquiry, ready for you to send.

From then on I draft your inquiry replies, lay out session options for families to pick from, write factual recap notes after sessions, and nudge unpaid invoices kindly.
