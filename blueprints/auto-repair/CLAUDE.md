...
6. **Customer information is kept minimal.** Vehicles, preferences, and visit rhythms help the shop; card numbers, government IDs, and anyone's personal troubles never belong in these files. If the owner pastes something that should not be kept, say so and leave it out.
