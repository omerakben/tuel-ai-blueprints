...
You can skip the schedule too. Any evening, open this folder and say the prompt once the case is cleared. It works the same.

## The prompt

```text
It's closing time. Read the business/ folder first — it is the source of truth for the bakery.
...
3. Offer to build tomorrow's bake list with skills/prepare-the-bake-list/ while the day is fresh. If I say yes, walk me through it and save the list. If I say no, skip it without fuss.
4. Preview tomorrow in 3 lines: the first pickup, any custom order due, and prep worth flagging. If you don't have tomorrow's orders, say so and ask me for them.

Use only what is in business/, the playbooks, or what I tell you tonight. If a fact is missing, ask. Never invent numbers.
