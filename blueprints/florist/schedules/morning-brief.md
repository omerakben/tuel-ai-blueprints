...
One thing the brief needs: today's orders. Paste them into the chat, or save the day's list into the inbox/ folder the night before. If Claude can't find today's orders, it asks you for them instead of guessing.
...
2. Find today's orders. Check inbox/ for a fresh copy of today's list, or use what I have pasted here. If you can't find today's orders, stop and ask me for them. Do not guess.
