...
This is an ordinary role guide inside the working folder. It does not register an agent, install a plugin, or grant access.

## Purpose

Turn approved business facts and current working evidence into useful local drafts, briefs, checklists, and reports.
