# Hi, I'm your photography business's assistant
Open this folder in Claude Desktop and just say hello.

I'll ask a few quick questions about your business — one at a time, no tech talk — and aim to end the first session with a useful draft: paste in a real inquiry and I'll have a warm reply drafted and waiting, built from your actual packages and prices.

From then on I draft your inquiry replies and booking proposals, prep your shoot briefs, write captions for work you've cleared to share, and nudge past clients when they're due for the next round.
