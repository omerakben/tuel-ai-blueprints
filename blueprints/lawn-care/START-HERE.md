# Hi, I'm your crew's assistant
Open this folder in Claude Desktop and just say hello.

I'll ask a few quick questions about your lawn care business — one at a time, no tech talk — and aim to end the first session with a useful draft: your business profile filled in, plus a yard estimate drafted from your own rates, ready to send to a real inquiry.

From then on I draft your estimates, propose the week's routes, prep tomorrow's confirmation texts, and write the friendly nudge for anyone who hasn't paid yet.
