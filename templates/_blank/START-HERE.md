# Welcome to {{NAME}}
Hi! This folder is a helping hand for {{NAME}}, your {{BUSINESS_TYPE}}.
Open it in Claude Desktop and just say hello — Claude takes it from there.
Claude asks easy questions, one at a time, and saves only what you approve.
The first session aims to end with a useful result.
You stay in charge the whole way: Claude shows you a draft first, every time.
Ready when you are. Say hello.
